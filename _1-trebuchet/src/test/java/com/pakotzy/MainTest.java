...
class MainTest {
    ...
    @Test
    void mainPartOneExample() throws IOException {
        String expected = "142";

        Main.main(new String[]{getPartOneExampleInput()});

        originalOut.print(testOut);
        assertTrue(testOut.toString().endsWith(expected), "Expected " + expected);
    }

    @Test
    void mainPartTwoExample() throws IOException {
        String expected = "281";

        Main.main(new String[]{getPartTwoExampleInput()});
    ...
    @Test
    void mainProblem() throws IOException {
        String expected = "55343";
        Main.main(new String[]{getProblemInput()});
    ...
    private String getPartOneExampleInput() {
        return """
                1abc2
                pqr3stu8vwx
                a1b2c3d4e5f
    ...
    private String getPartTwoExampleInput() {
        return """
                two1nine
                eightwothree
                abcone2threexyz
